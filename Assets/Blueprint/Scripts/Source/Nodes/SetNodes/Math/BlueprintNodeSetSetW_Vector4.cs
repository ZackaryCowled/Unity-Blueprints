...
[System.Serializable]
public class BlueprintNodeSetSetW_Vector4 : BlueprintNodeSet
{
	...
	public override void Execute()
	{
		...
		if (connections[0].connectionNodeID > -1 && connections[1].connectionNodeID > -1)
		{
			...
			inputAttribute.w = (float)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[1].connectionNodeID).GetAttribute();
