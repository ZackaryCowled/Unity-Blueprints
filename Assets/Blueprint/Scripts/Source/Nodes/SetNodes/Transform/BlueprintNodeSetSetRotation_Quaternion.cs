...
[System.Serializable]
public class BlueprintNodeSetSetRotation_Quaternion : BlueprintNodeSet
{
	...
	public override void Execute()
	{
		...
		{
			//Set the blueprints parents GameObjects rotation to the attribute Quaternion rotation
