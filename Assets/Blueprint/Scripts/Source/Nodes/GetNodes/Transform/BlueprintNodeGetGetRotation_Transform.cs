...
[System.Serializable]
public class BlueprintNodeGetGetRotation_Transform : BlueprintNodeGet
{
	...
	public override object GetAttribute()
	{
		...
		if (connections[0].connectionNodeID > -1)
		{
			...
			return ((Transform)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[0].connectionNodeID).GetAttribute()).rotation.eulerAngles;
		}
	...
	//Returns the blueprint node get get rotation default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node get get rotation default output attribute
