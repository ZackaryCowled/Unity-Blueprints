...
[System.Serializable]
public class BlueprintNodeGetGetX_Vector2 : BlueprintNodeGet
{
	...
	public override object GetAttribute()
	{
		...
		if (connections[0].connectionNodeID > -1)
		{
			...
			return ((Vector2)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[0].connectionNodeID).GetAttribute()).x;
		}
	...
	{
		//Render the Vector2 vector label
		BeginSection(1);
		GUILayout.Label("Vector2 : vector", BlueprintStyleHelper.GetNodeAttributeTextStyle());
		EndSection();
	}
#endif
}