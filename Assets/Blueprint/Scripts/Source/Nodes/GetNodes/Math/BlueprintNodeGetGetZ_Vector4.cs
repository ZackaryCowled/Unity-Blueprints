...
[System.Serializable]
public class BlueprintNodeGetGetZ_Vector4 : BlueprintNodeGet
{
	...
	public override object GetAttribute()
	{
		...
		if (connections[0].connectionNodeID > -1)
		{
			...
			return ((Vector4)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[0].connectionNodeID).GetAttribute()).z;
		}
