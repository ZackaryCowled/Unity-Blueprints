...
[System.Serializable]
public class BlueprintNodeGetGetY_Vector2 : BlueprintNodeGet
{
	...
	public override object GetAttribute()
	{
		...
		if (connections[0].connectionNodeID > -1)
		{
			...
			return ((Vector2)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[0].connectionNodeID).GetAttribute()).y;
		}
