...
[System.Serializable]
public class BlueprintNodeGetGetW_Quaternion: BlueprintNodeGet
{
	...
	public override object GetAttribute()
	{
		...
		if (connections[0].connectionNodeID > -1)
		{
			...
			return ((Quaternion)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[0].connectionNodeID).GetAttribute()).w;
		}
