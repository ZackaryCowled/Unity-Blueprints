...
[System.Serializable]
public class BlueprintNodeEventGetMouseButtonDown : BlueprintNodeEventCondition
{
	//Public attributes
	public int selectedMouseButton = 0;

	//Returns a flag indicating whether the blueprint node event get mouse button down condition is being met
