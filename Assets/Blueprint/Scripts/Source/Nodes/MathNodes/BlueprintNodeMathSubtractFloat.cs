...
[System.Serializable]
public class BlueprintNodeMathSubtractFloat : BlueprintNodeMath
{
	//Returns the blueprint node math subtract float output attribute
	...
	//Returns the blueprint node math subtract float default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math subtract float default output attribute
		return 0.0f;
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math subtract float instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math subtract float
	...
	//Returns the blueprint node math subtract float title
	protected override string GetTitle()
	{
		//Return the blueprint node math subtract float title
		return "SubtractFloat";
	}

	//Renders the blueprint node math subtract float body components
