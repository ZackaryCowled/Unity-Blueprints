...
[System.Serializable]
public class BlueprintNodeMathAddInt : BlueprintNodeMath
{
	...
	//Returns the blueprint node math add int default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math add int default output attribute
		return 0;
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math add int instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math add int
	...
	//Returns the blueprint node math add int title
	protected override string GetTitle()
	{
		//Return the blueprint node math add int title
		return "AddInt";
	}

	//Renders the blueprint node math add int body components
