...
[System.Serializable]
public class BlueprintNodeMathMultiplyFloat : BlueprintNodeMath
{
	//Returns the blueprint node math multiply float output attribute
	...
	//Returns the blueprint node math multiply float default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math multiply float default output attribute
		return 0.0f;
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math multiply float instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math multiply float
	...
	//Returns the blueprint node math multiply float title
	protected override string GetTitle()
	{
		//Return the blueprint node math multiply float title
		return "MultiplyFloat";
	}

	//Renders the blueprint node math multiply float body components
