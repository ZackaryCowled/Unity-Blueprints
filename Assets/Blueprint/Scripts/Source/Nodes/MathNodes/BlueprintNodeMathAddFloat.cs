...
public class BlueprintNodeMathAddFloat : BlueprintNodeMath
{
	//Returns the blueprint node math add float output attribute
	...
	//Returns the blueprint node math add float default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math add float default output attribute
		return 0.0f;
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math add float instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math add float
	...
	//Returns the blueprint node math add float title
	protected override string GetTitle()
	{
		//Return the blueprint node math add float title
		return "AddFloat";
	}

	//Renders the blueprint node math add float body components
