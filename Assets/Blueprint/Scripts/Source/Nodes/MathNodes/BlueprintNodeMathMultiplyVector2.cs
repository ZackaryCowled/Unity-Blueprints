...
[System.Serializable]
public class BlueprintNodeMathMultiplyVector2 : BlueprintNodeMath
{
	//Returns the blueprint node math multiply vector2 output attribute
	...
	//Returns the blueprint node math multiply vector2 default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math multiply vector2 default output attribute
		return new Vector2(0.0f, 0.0f);
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math multiply vector2 instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math multiply vector2
	...
	//Returns the blueprint node math multiply vector2 title
	protected override string GetTitle()
	{
		//Return the blueprint node math multiply vector2 title
		return "MultiplyVector2";
	}

	//Renders the blueprint node math multiply vector2 body components
