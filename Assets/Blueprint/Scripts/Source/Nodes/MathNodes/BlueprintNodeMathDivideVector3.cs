...
[System.Serializable]
public class BlueprintNodeMathDivideVector3 : BlueprintNodeMath
{
	//Returns the blueprint node math divide vector3 output attribute
	...
	//Returns the blueprint node math divide vector3 default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math divide vector3 default output attribute
		return new Vector3(0.0f, 0.0f, 0.0f);
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math divide vector3 instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math divide vector3
	...
	//Returns the blueprint node math divide vector3 title
	protected override string GetTitle()
	{
		//Return the blueprint node math divide vector3 title
		return "DivideVector3";
	}

	//Renders the blueprint node math divide vector3 body components
