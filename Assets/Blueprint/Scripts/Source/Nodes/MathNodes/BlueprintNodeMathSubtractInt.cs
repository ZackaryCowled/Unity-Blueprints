...
[System.Serializable]
public class BlueprintNodeMathSubtractInt : BlueprintNodeMath
{
	//Returns the blueprint node math subtract int output attribute
	...
	//Returns the blueprint node math subtract int default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math subtract int default output attribute
		return 0;
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math subtract int instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math subtract int
	...
	//Returns the blueprint node math subtract int title
	protected override string GetTitle()
	{
		//Return the blueprint node math subtract int title
		return "SubtractInt";
	}

	//Renders the blueprint node math subtract int body components
