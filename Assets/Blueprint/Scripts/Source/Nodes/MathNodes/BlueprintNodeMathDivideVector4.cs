...
[System.Serializable]
public class BlueprintNodeMathDivideVector4 : BlueprintNodeMath
{
	//Returns the blueprint node math divide vector4 output attribute
	...
	//Returns the blueprint node math divide vector4 default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math divide vector4 default output attribute
		return new Vector4(0.0f, 0.0f, 0.0f);
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math divide vector4 instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math divide vector4
	...
	//Returns the blueprint node math divide vector4 title
	protected override string GetTitle()
	{
		//Return the blueprint node math divide vector4 title
		return "DivideVector4";
	}

	//Renders the blueprint node math divide vector4 body components
