...
[System.Serializable]
public class BlueprintNodeMathSlerpVector3 : BlueprintNodeMath
{
	//Returns the blueprint node math slerp vector3 output attribute
	public override object GetAttribute()
	{
		...
		if (connections[0].connectionNodeID > -1 && connections[1].connectionNodeID > -1 && connections[2].connectionNodeID > -1)
		{
			...
			return Vector3.Slerp((Vector3)BlueprintInstanceManager.GetBlueprintAt(blueprintID).GetBlueprintNodeAt(connections[0].connectionNodeID).GetAttribute(),
	...
	//Returns the blueprint node math slerp vector3 default output attribute
	public override object GetDefaultOutputAttribute()
	{
		//Return the blueprint node math slerp vector3 default output attribute
		return new Vector3(0.0f, 0.0f, 0.0f);
	}

//If running in the Unity Editor
#if UNITY_EDITOR
	//Initializes the blueprint node math slerp vector3 instance
	public override void Initialize()
	{
		//Perform base initialization
		base.Initialize();

		//Initialize the blueprint node math slerp vector3
	...
	//Returns the blueprint node math slerp vector3 title
	protected override string GetTitle()
	{
		//Return the blueprint node math slerp vector3 title
		return "SlerpVector3";
	}

	//Renders the blueprint node math slerp vector3 body components
