...
public class BlueprintConnectionAttributeInputTransform : BlueprintConnectionAttributeInput
{
//If running in the Unity Editor
	...
	{
		//If the specified blueprint connection is of type blueprint connection attribute output transform
		if (blueprintConnection as BlueprintConnectionAttributeOutputTransform != null)
		{
