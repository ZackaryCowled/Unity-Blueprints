...
public class BlueprintConnectionAttributeOutputGameObject : BlueprintConnectionAttributeOutput
{
//If running in the Unity Editor
	...
	{
		//If the specified blueprint connection is of type blueprint connection attribute input gameobject
		if (blueprintConnection as BlueprintConnectionAttributeInputGameObject != null)
		{
