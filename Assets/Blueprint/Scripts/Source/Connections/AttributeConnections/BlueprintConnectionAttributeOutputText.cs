...
public class BlueprintConnectionAttributeOutputText : BlueprintConnectionAttributeOutput
{
//If running in the Unity Editor
	...
	{
		//If the specified blueprint connection is of type blueprint connection attribute input text
		if (blueprintConnection as BlueprintConnectionAttributeInputText != null)
		{
