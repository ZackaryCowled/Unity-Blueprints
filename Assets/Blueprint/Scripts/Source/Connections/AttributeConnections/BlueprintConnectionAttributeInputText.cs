...
public class BlueprintConnectionAttributeInputText : BlueprintConnectionAttributeInput
{
//If running in the Unity Editor
	...
	{
		//If the specified blueprint connection is of type blueprint connection attribute output text
		if (blueprintConnection as BlueprintConnectionAttributeOutputText != null)
		{
