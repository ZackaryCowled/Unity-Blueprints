...
public class BlueprintConnectionAttributeOutputTransform : BlueprintConnectionAttributeOutput
{
//If running in the Unity Editor
	...
	{
		//If the specified blueprint connection is of type blueprint connection attribute input transform
		if (blueprintConnection as BlueprintConnectionAttributeInputTransform != null)
		{
