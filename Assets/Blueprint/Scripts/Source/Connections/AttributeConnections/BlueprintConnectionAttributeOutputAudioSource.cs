...
public class BlueprintConnectionAttributeOutputAudioSource : BlueprintConnectionAttributeOutput
{
//If running in the Unity Editor
	...
	{
		//If the specified blueprint connection is of type blueprint connection attribute input audio source
		if (blueprintConnection as BlueprintConnectionAttributeInputAudioSource != null)
		{
